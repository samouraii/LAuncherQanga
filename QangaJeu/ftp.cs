    ...
    class ftp
    {
        ...
        public void download(string remoteFile, string localFile, System.ComponentModel.BackgroundWorker backgroundWorker1)
              ...
              long sizeMax = test;
                ...
                try
                {
                    ...
                    while (bytesRead > 0)
                    {
                        ...
                        progress = Convert.ToInt32(totalReadBytesCount * 100.0 /sizeMax);
                        if(backgroundWorker1 != null)  backgroundWorker1.ReportProgress((int)progress);
            ...
            public long getFileSize(string fileName)
            {
                ...
                {
                    /* Create an FTP Request */
                    ftpRequest = (FtpWebRequest)FtpWebRequest.Create(host  + fileName.Replace('\\','/'));
                    /* Log in to the FTP Server with the User Name and Password Provided */
                    ftpRequest.Credentials = new NetworkCredential(user, pass);
                    /* When in doubt, use these options */
                    ftpRequest.UseBinary = true;
